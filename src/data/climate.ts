...
export const CLIMATE_LOCATIONS: ClimateLocation[] = [
  {
    ...
    overviewDescription: 'Area-specific passive solar heat capture and high thermal inertia shelter engineering for Leh-Ladakh defense outposts (3,524m MSL). Evaluates dynamic sol-air irradiance under sub-zero ambient swings with high DNI solar gain.',
